            ...
            <div className="usedetail-table-cls-inner">
              <table>
                ...
                <tr>
                 ...
                 <td>{detail?.state?.email}</td>
                 <td>{detail?.state?.email_verify == "true" ? (
                  <span>Verified</span>
                ) : (
                ...
                {detail?.state?.kyc_verify ? (
                 ...
                 <td>{detail?.state?.TotalBalance ? detail?.state?.TotalBalance.toFixed(6) : 0}</td>
                 <td><div className="two_buttons">
...
{detail?.state?.suspend &&              <CButton
            ...
            {/* <div>
              ...
              <p> TotalBalance : {detail?.state?.TotalBalance ? detail?.state?.TotalBalance.toFixed(6) : 0}</p>
